...
RDS_INSTANCE_HOST=pu2sqczmy1cm8z.chvacs07t92e.ap-south-1.rds.amazonaws.com
...
KEYPATH=$DIRECTORY/ec2_instance_connect_rsa
echo $KEYPATH
if [ -f $KEYPATH ]; then
...
# Forward remote RDS port to local port 38081
ssh -i $KEYPATH -N -L 38081:$RDS_INSTANCE_HOST:5432 $BASTION_USER@$BASTION_HOST